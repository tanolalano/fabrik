...
class FabrikModelSchemaUpdate extends FabModelAdmin
{
	/**
	 * @var		string	The prefix to use with controller messages.
	 * @since	1.6
	 */
	protected $text_prefix = 'COM_FABRIK_SCHEMA_UPDATE';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_fabrik.group', 'schemaupdate', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
		return $form;
